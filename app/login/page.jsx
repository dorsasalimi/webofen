...
export default function Login() {
    ...
    return (
        <div className="min-h-screen  flex justify-center items-center p-4 md:p-0 relative overflow-hidden w-full">
                        <motion.div
                className="absolute top-20 left-20 w-80 h-80 rounded-full bg-blue-500/30 blur-3xl"
                animate={{
                    x: [0, 200, 0],
                    y: [0, 100, 0],
                    opacity: [0.5, 0.7, 0.5]
            ...
            />
            <motion.div className='flex justify-center p-4 md:p-0 relative items-center bg-[url(/image/finalchat.png)] w-1/2'
            ...
            <motion.div
                className="bg-white/10 backdrop-blur-sm w-full max-w-5xl rounded-2xl overflow-hidden shadow-2xl flex flex-col md:flex-row"
            ...
            >
                ...
                <motion.div
                    className="w-full md:w-1/2 p-8 pb-2 md:p-12 "
                ...
                >
                    ...
                    <motion.div
                        ...
                        variants={itemVariants}
                    >
                        © {new Date().getFullYear()} وبوفن. تمامی حقوق محفوظ است.
                    </motion.div>
                </motion.div>
                <motion.div
                    className="w-full md:w-1/2 relative h-64 md:h-auto overflow-hidden flex justify-center items-center "
