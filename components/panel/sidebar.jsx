...
const sidebar = () => {
    return (
        <div className="bg-white w-4/6 m-auto h-full sm:m-0">
            <div className="flex">
                <div className="bg-white w-5/6 flex rounded-br-xl justify-between p-6">
                    ...
                    <h1 className="text-[#755585] font-semibold">WEBOFEN</h1>
                    <div></div>
                </div>
                <div className="w-1/6 flex flex-wrap justify-center rounded-tl-xl p-6">
