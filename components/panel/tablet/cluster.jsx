        ...
        <>
            ...
            <div className="flex">
                <div className=" w-1/3 text-end rounded-md ">
                    <div className="bg-white text-black rounded-t-lg h-full flex justify-center items-end">
                        <span className="font-semibold pt-4 text-gray-700">کلاستر</span>
                    </div>
                </div>
                <div className=" w-1/3">
                </div>
            ...
            <div className="bg-white h-auto text-white w-full rounded-b-lg rounded-tl-lg text-end p-1 md:p-8">
                <div className="flex flex-col mt-4">
                    {Array.isArray(cluster) && cluster.map((item) => (
                        item.status === 0 ? (
                            ...
                            <div className="block mt-2" key={item.id}>
                                <ProgressList datetime={item.datetime} />
                            </div>
                        )
                    ))}
                </div>
